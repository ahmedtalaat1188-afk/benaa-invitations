...
namespace BenaaInvitations.API.Controllers
{
    ...
    public class EventsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetWhatsAppMessage(int guestId)
        {
            ...
            // Use the actual frontend URL (Netlify) instead of hardcoded benaa.sa
            string host = Request.Headers["Origin"].ToString();
            if (string.IsNullOrEmpty(host)) host = "https://eventbenaa.netlify.app";
            
            string confirmUrl = $"{host}/rsvp/confirm/{guest.SecureToken}";
        ...
        public async Task<IActionResult> GetTicketWhatsAppMessage(int guestId)
        {
            ...
            string ticketUrl = $"{host}/t/{guest.SecureToken}";
